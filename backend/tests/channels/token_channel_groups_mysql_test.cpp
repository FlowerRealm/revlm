...
int main()
{
    ...
    try {
        ...
        const int enabled_group_id = groups.create_channel_group("openai_compatible", enabled_name, "", 1.25, true);
        const int alt_group_id = groups.create_channel_group("openai_compatible", "tmp-alt-" + suffix, "", 1.0, true);
        const int disabled_group_id =
            groups.create_channel_group("openai_compatible", "tmp-disabled-" + suffix, "", 1.0, false);
