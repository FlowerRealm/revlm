...
|-------|-----------------|----------------|
| Auth / session / token | `revlm_auth_middleware_test`, `revlm_auth_middleware_mysql_test`, `revlm_user_api_mysql_test`, `revlm_token_api_mysql_test`, `revlm_token_channel_groups_mysql_test`, `revlm_admin_users_test` | Register/login/logout, opaque session cookie, token CRUD/bindings, admin user mutations |
