...
int main()
{
    try {
        ...
        const std::string list_resp =
            request_with_session("GET", "/api/token", "", user_id, session.value, config, "req-token-list");
        ...
        const std::string reveal_resp =
            request_with_session("GET", reveal_path, "", user_id, session.value, config, "req-token-reveal");
        ...
        const std::string rotate_resp =
            request_with_session("POST", rotate_path, "", user_id, session.value, config, "req-token-rotate");
        ...
        const std::string bind_channel_resp = request_with_session(
            "PUT", channel_path, bind_channel_body, user_id, session.value, config, "req-token-bind-channel");
        ...
        const std::string channel_get_resp =
            request_with_session("GET", channel_path, "", user_id, session.value, config, "req-token-get-channel");
        ...
        const std::string revoke_resp =
            request_with_session("POST", revoke_path, "", user_id, session.value, config, "req-token-revoke");
        ...
        const std::string reveal_revoked_resp = request_with_session("GET", reveal_path, "", user_id, session.value,
                                                                     config, "req-token-reveal-revoked");
        ...
        const std::string delete_resp =
            request_with_session("DELETE", delete_path, "", user_id, session.value, config, "req-token-delete");
        ...
        const std::string delete_missing_resp = request_with_session("DELETE", delete_path, "", user_id, session.value,
                                                                     config, "req-token-delete-missing");
